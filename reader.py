    ...
    def run(self, opened=False):
        ...
        with codecs.open(s,'w', 'shift_jis') as f0:
            f0.write(
                ...
                u'［＃本文終わり］\n'+
                u'バージョン――［＃「バージョン――」は中見出し］\n'+
                u'［＃１字下げ］非安定版　2015［＃「2015」は縦中横］年5［＃「5」は縦中横］月6［＃「6」は縦中横］日\n'+
                u'\n'+
                ...
                u'・全体的《ぜんたいてき》［＃「全体的」に傍点］に動作《どうさ》［＃「動作」に白丸傍点］が遅《おそ》いです。\n'+
                u'・行末揃え［＃「行末揃え」の左に「ぎょうまつそろえ」のルビ］［＃「行末揃え」の左に白丸傍点］は不完全［＃「不完全」の左に「ふかんぜん」のルビ］です。これは文字［＃「文字」の左に「もじ」のルビ］［＃「文字」の左に傍点］の均等割付［＃「均等割付」の左に「きんとうわりつけ」の注記］を行わない為です。\n'+
