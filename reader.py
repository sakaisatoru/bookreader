    ...
    def run(self, opened=False):
        ...
        with codecs.open(s,'w', 'shift_jis') as f0:
            f0.write(
                ...
                u'［＃本文終わり］\n'+
                u'――バージョン――［＃「――バージョン――」は中見出し］\n'+
                u'［＃１字下げ］夜間構築版《やかんこうちくばん》　2017［＃「2017」は縦中横］年7［＃「7」は縦中横］月17［＃「17」は縦中横］日\n'+
                u'\n'+
                u'このプログラムについて［＃「このプログラムについて」は中見出し］\n'+
                u'［＃ここから１字下げ］'+
                u'青空文庫《あおぞらぶんこ》［＃「青空文庫」の左に「aozora bunko」のルビ］［＃「青空文庫」に傍点］［＃「青空文庫」に傍線］ http://www.aozora.gr.jp/ のテキストファイル［＃「テキストファイル」に丸傍点］を Pango と GTK+2 と Python2 を使って縦書《たてが》［＃「縦書」の左に「タテガ」のルビ］き［＃「縦書き」の左に白ゴマ傍点］で読もう、というものです。\n'+
                u'［＃字下げ終わり］\n'+
                u'\n'+
