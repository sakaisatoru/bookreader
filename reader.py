...
class ReaderUI(gtk.Window, ReaderSetting):
    ...
    def menu_about_cb(self, widget):
        ...
        dlg.set_copyright(u'by sakai satoru 2018')
        dlg.run()
        dlg.destroy()
    ...
    def run(self, opened=False):
        ...
        with codecs.open(s,'w', 'shift_jis') as f0:
            f0.write(
                ...
                u'［＃本文終わり］\n'+
                u'――バージョン――［＃「――バージョン――」は中見出し］\n'+
                u'［＃１字下げ］夜間構築版《やかんこうちくばん》　2018［＃「2018」は縦中横］年7［＃「7」は縦中横］月19［＃「19」は縦中横］日\n'+
                u'\n'+
                u'このプログラムについて［＃「このプログラムについて」は中見出し］\n'+
                u'［＃ここから１字下げ］'+
                u'青空文庫《あおぞらぶんこ》 http://www.aozora.gr.jp/ のテキストファイルを Pango と GTK+2 と Python2 を使って縦書《たてが》きで読もう、というものです。\n'+
                u'［＃字下げ終わり］\n'+
                u'\n'+
