    ...
    def run(self, opened=False):
        ...
        with codecs.open(s,'w', 'shift_jis') as f0:
            f0.write(
                ...
                u'［＃本文終わり］\n'+
                u'――バージョン――［＃「――バージョン――」は中見出し］\n'+
                u'［＃１字下げ］非安定版　2016［＃「2016」は縦中横］年2［＃「2」は縦中横］月18［＃「18」は縦中横］日\n'+
                u'\n'+
                ...
                u'［＃字下げ終わり］\n'+
                u'\n'+
                u'［＃ここから窓小見出し］窓見出しのテスト［＃ここで窓小見出し終わり］ほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげほげ\n' +
                ...
                u'［＃ここから１字下げ、折り返して２字下げ］'+
                u'・縦中横で組まれた文字にルビを正しく付すことができません。但し左ルビは表示されます。\n'+
                u'・割り注内に他の修飾が出現すると割り注そのものがエラーになります。\n'+
